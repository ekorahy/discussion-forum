  ...
  return (
    <section id="login" className="h-min-screen">
      <div className="flex flex-wrap flex-row">
        <div className="w-full bg-slate-50 flex items-center md:w-3/5">
        ...
        <div className="w-full self-center p-8 md:w-2/5">
          <h1 className="font-Philosopher font-bold text-4xl text-primary">Form Login</h1>
          <p className="font-Quicksand mt-2 mb-4">Please Login to continue into the application.</p>
