      ...
      <div className='flex flex-col'>
        <div className='flex items-center border-b border-b-slate-200 pt-6 px-6 pb-4 '>
          ...
          <div className='flex-col'>
            <h1 className='font-Quicksand font-bold text-xl'>{name}</h1>
            <p className='font-Quicksand text-slate-400'>{email}</p>
          </div>
        </div>
        <button className='flex items-center justify-center font-semibold font-Quicksand p-4 text-red-700 hover:text-red-500' type='button' onClick={signOut}>
