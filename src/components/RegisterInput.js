...
function RegisterInput({ register }) {
  ...
  return (
    <form>
      ...
      <button className="w-full bg-primary font-Quicksand text-white border-2 mt-2 rounded py-2 px-4 hover:bg-primaryHover md:h-16 md:text-xl md:mt-4 lg:text-base lg:h-10" type="button" onClick={() => register({ name, email, password })}>Register</button>
    </form>
  );
}
